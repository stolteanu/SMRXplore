...
const TREND_CAP_PCT = 100; // % de variation (ou points d'écart pour une mesure déjà en %) au-delà duquel la couleur du dégradé sature
...
function trendDelta(cur, prev, isPct) {
  ...
  if (prev === 0) return cur === 0 ? null : (cur > 0 ? TREND_CAP_PCT : -TREND_CAP_PCT);
